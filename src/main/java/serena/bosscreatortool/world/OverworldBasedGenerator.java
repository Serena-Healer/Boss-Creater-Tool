...
public class OverworldBasedGenerator implements IChunkGenerator {
    ...
    public OverworldBasedGenerator(World worldIn, long seed)
    {
        {
        ...
        this.settings = ChunkGeneratorSettings.Factory.jsonToFactory(worldIn.getWorldInfo().getGeneratorOptions()).build();
