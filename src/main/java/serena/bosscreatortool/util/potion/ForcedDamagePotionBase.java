...
public class ForcedDamagePotionBase extends CustomPotionBase{

    double multiplier;
    String type;

    public ForcedDamagePotionBase(String name, boolean isBadEffectIn, int liquidColorIn, int iconX, int iconY, double multiplier, String type) {
